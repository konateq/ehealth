...
public class CDABodyUtils {
    ...
    public static void addComponent(Namespace hl7Namespace, Element rootElement, DispenseRequest dispenseRequest, org.jdom2.Document ePDocument) {
        ...
        CDAUtils.addTemplateId(hl7Namespace, section, Templates.EHDSI_DISPENSATION_SECTION);
        ...
        CDAUtils.addId(hl7Namespace, identifier, section);
