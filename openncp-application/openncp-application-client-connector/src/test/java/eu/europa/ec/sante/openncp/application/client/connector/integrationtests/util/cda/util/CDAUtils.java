...
public class CDAUtils {
    ...
    public static byte[] generateDispensationDocument(DispenseRequest dispenseRequest,
        ...
        CDAHeaderUtils.addRecordTarget(rootElement, ePDocument);
        CDAHeaderUtils.addAuthor(HL7_NAMESPACE, rootElement, getAuthorInformation());
        CDAHeaderUtils.addCustodian(HL7_NAMESPACE, rootElement, getCustodianInformation());
        CDAHeaderUtils.addLegalAuthenticator(HL7_NAMESPACE, rootElement, getLegalAuthenticatorInformation());
        CDAHeaderUtils.addInFulfillmentOf(HL7_NAMESPACE, rootElement, ePDocument);
        CDABodyUtils.addComponent(HL7_NAMESPACE, rootElement, dispenseRequest, ePDocument);
