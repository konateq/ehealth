...
<div class="main">
    ...
    <form:form method="post" action="query" modelAttribute="queryBean">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td colspan="6">
                    <span class="emphed">A '*' can be used for Ids and Type Codes as a wildcard at the beginning and end of values.</span>
                </td>
            </tr>
            <tr>
                <td>Event Id Code :</td>
