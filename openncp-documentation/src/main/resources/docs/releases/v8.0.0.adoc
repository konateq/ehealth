...
`eu.europa.ec.sante.openncp.core.common.fhir.services.FhirDispatchingService`
...
`META-INF/services/eu.europa.ec.sante.openncp.core.common.fhir.services.FhirDispatchingService` +
...
@Service
public class YourNIFhirDispatchingService implements FhirDispatchingService {
...
public class YourNIConfigurationClass {
    ...
    @Bean
    @Primary
    public FhirDispatchingService fhirDispatchingService() {
        return new YourNIFhirDispatchingService();
    }
}
----
