...
A general advise is to create a national connector that links the OpenNCP server component with the national infrastructure. Doing so favours loose coupling and makes it easier to migrate towards a Spring-based solution.
