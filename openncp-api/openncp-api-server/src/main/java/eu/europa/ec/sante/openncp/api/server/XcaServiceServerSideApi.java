...
import eu.europa.ec.sante.openncp.core.server.ihe.xca.XcaServiceServerSide;
...
public class XcaServiceServerSideApi implements RespondingGatewayPortType {
    private static final Logger LOGGER = LoggerFactory.getLogger(XcaServiceServerSideApi.class);
    ...
    private final XcaServiceServerSide service;

    public XcaServiceServerSideApi(final XcaServiceServerSide service) {
