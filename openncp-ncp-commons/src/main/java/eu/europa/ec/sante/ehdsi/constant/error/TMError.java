...
public enum TMError implements ITMTSAMError, ErrorCode {
     ...
     */
    ERROR_REQUIRED_CODED_ELEMENT_NOT_TRANSCODED("4505", "Required coded element was not transcoded"),
    /**
     ...
     */
    ERROR_HEADER_CODED_ELEMENT_PROCESSING_FAILURE("4506", "Header coded processing failure"),
    /**
     * Error; List of item(s) missing or wrong <br>
     * code, description:<br>
     ...
     */
    WARNING_HEADER_CODED_ELEMENT_NOT_TRANSCODED("2500", "Header coded element transcoding failure"),
    /**
     * Warning; Parent document not correctly referenced <br>
     * code, description:<br>
     * "2501","Parent document not correctly referenced"
     */
    WARNING_PARENT_DOCUMENT_NOT_CORRECTLY_REFERENCED("2501", "Parent document not correctly referenced"),
    /**
     ...
     */
    WARNING_CODED_ELEMENT_LIST_EMPTY("2506", "Configuration Coded Element List is Empty"),
    /**
